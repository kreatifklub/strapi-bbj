...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    care_guide: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'BBJ Configuaration';
    ...
    > &
      Schema.Attribute.Private;
    materials_quality: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'BBJ Configuaration';
    ...
    publishedAt: Schema.Attribute.DateTime;
    recommended: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiRegisterRegister extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    privacy_text: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'BBJ Configuaration';
